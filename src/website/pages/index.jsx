            ...
            <div>
                ...
                <div className="tm-main-section light-gray-bg">
                    <div className="container" id="main">
                        ...
                        {/* TODAY'S SPECIAL */} <section className="tm-section today-special-layout row"> <div className="col-lg-12 tm-section-header-container"> <h2 className="tm-section-header gold-text tm-handwriting-font"> <img src="img/logo.png" alt="Logo" className="tm-site-logo" /> Today's Special </h2> <div className="tm-hr-container"><hr className="tm-hr" /></div> </div> <div className="col-lg-12 tm-special-container margin-top-60"> {/* LEFT SPECIAL ITEM */} <div className="tm-special-item-left"> <div className="tm-special-img-container"> <img src="img/poster1.png" alt="Special" className="tm-special-img img-responsive" /> <a href="#"> <div className="tm-special-description"> <h3 className="tm-special-title">Coffee of the Day</h3> <p>Our master-roasted beans delivering a deep, smooth & aromatic experience.</p> </div> </a> </div> </div> {/* RIGHT SPECIAL ITEMS */} <div className="tm-special-column-right"> {/* Top right item */} <div className="tm-special-item-upper"> <div className="tm-special-img-container"> <img src="img/poster2.png" alt="Special" className="tm-special-img img-responsive" /> <a href="#"> <div className="tm-special-description"> <h3 className="tm-special-title">Snacks</h3> <p>Yummy snacks......</p> </div> </a> </div> </div> {/* Bottom row with 2 items */} <div className="tm-special-row-lower"> <div className="tm-special-item-lower"> <div className="tm-special-img-container"> <img src="img/poster4.png" alt="Special" className="tm-special-img img-responsive" /> <a href="#"> <div className="tm-special-description"> <p>Pastries & Desserts</p> </div> </a> </div> </div> <div className="tm-special-item-lower"> <div className="tm-special-img-container"> <img src="img/poster3.png" alt="Special" className="tm-special-img img-responsive" /> <a href="#"> <div className="tm-special-description"> <p>Healthy Drinks</p> </div> </a> </div> </div> </div> </div> </div> </section>
